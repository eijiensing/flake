...
Scope {
    ...
    property var activeScreen: {
        ...
        if (!Hyprland.focusedMonitor) return Quickshell.screens[0];
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            height: 32
                            radius: 8
                            color: sidebarContent.currentTab === 0 ? root.primaryColor : "transparent"
                            Behavior on color { ColorAnimation { duration: 200 } }

                            Text {
                                text: "Notifications"
                                anchors.centerIn: parent
                                color: sidebarContent.currentTab === 0 ? root.backgroundColor : root.secondaryColor
                                font.pixelSize: 14
                                font.bold: true
                                Behavior on color { ColorAnimation { duration: 200 } }
                            }
                            ...
                            MouseArea {
                                ...
                                onClicked: sidebarContent.currentTab = 0
                            }
                        }
                        ...
                        Rectangle {
                            ...
                            height: 32
                            radius: 8
                            color: sidebarContent.currentTab === 1 ? root.primaryColor : "transparent"
                            Behavior on color { ColorAnimation { duration: 200 } }

                            Text {
                                text: "System Tray"
                                anchors.centerIn: parent
                                color: sidebarContent.currentTab === 1 ? root.backgroundColor : root.secondaryColor
                                font.pixelSize: 14
                                font.bold: true
                                Behavior on color { ColorAnimation { duration: 200 } }
                            }
                            ...
                            MouseArea {
                                anchors.fill: parent
                                cursorShape: Qt.PointingHandCursor
                                onClicked: sidebarContent.currentTab = 1
                            }
                        }
                    }
